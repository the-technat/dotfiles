-- ================================================================================================
-- title : Technat's NeoVim Config
-- credits: mostly copied from https://github.com/radleylewis/nvim-lite/blob/youtube_demo/init.lua
-- ================================================================================================
...
vim.opt.list = true                                -- Render whitespace chars differently       
...
vim.opt.confirm = true                             -- Confirm quitting without saving changes
...
vim.keymap.set('n', '<leader>tnn', ':tabnew<CR>', { desc = 'New tab' })
...
--  signs = {
--    text = {
--      [vim.diagnostic.severity.ERROR] = "Γ£ù",
--      [vim.diagnostic.severity.WARN] = "ΓÜá",
--      [vim.diagnostic.severity.INFO] = "Γä╣",
--      [vim.diagnostic.severity.HINT] = "≡ƒÆí",
--    }
--  }
-- })
